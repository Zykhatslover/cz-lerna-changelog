...
var _getScopes = require('./get-scopes');
...
function makePrompter() {
  ...
  return function (cz, commit) {
    getAllPackages().then(function (pkgs) {
      ...
      var defaultScope = (0, _getScopes.getDefaultScope)();

      var defaultQuestions = (0, _makeDefaultQuestions2.default)({ allPackages: allPackages, changedPackages: changedPackages, allScopes: _getScopes.scopes, defaultScope: defaultScope });
